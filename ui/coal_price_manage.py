...
class Ui_CoalPrice(object):
    def setupUi(self, CoalPrice):
        ...
        self.coal_sell_price_display.setGeometry(QtCore.QRect(190, 260, 101, 20))
        ...
        self.coal_purchase_price_display.setGeometry(QtCore.QRect(190, 150, 101, 20))
        ...
        self.purchase_compute_unit.setGeometry(QtCore.QRect(290, 180, 69, 22))
        self.purchase_compute_unit.setObjectName("purchase_compute_unit")
        self.coal_purchase_price_label = QtWidgets.QLabel(CoalPrice)
        self.coal_purchase_price_label.setGeometry(QtCore.QRect(260, 180, 31, 16))
        ...
        self.purchase_price_check_box.setGeometry(QtCore.QRect(60, 150, 121, 16))
    ...
    def retranslateUi(self, CoalPrice):
        ...
        CoalPrice.setWindowTitle(_translate("CoalPrice", "煤价管理"))
        ...
        self.purchase_price_check_box.setText(_translate("CoalPrice", "勾选修改进价"))
        self.sell_price_check_box.setText(_translate("CoalPrice", "勾选修改售价"))
        self.coal_sell_price_label.setText(_translate("CoalPrice", "单位"))
        self.purchase_price_change_label.setText(_translate("CoalPrice", "输入新价格"))
        self.sell_price_change_label.setText(_translate("CoalPrice", "输入新价格"))
