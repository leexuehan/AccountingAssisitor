...
class ConfigFileUtils(object):
    ...
    def read_sort_list(sort_name):
        conf = ConfigParser()
        conf.read("..\\init\\sortlist.init", encoding='utf-8')
    ...
    def add_item_into_sorts(item_name, sort_name):
        ...
        conf.write(open("..\\init\\sortlist.init", "w", encoding='utf-8'))
...
# init.set("section2", "port", "8081")
#
# # 写入指定section, 增加新option的值
# init.set("section2", "IEPort", "80")
#
# # 添加新的 section
# init.add_section("new_section")
# init.set("new_section", "new_option", "http://www.cnblogs.com/tankxiao")
#
# # 写回配置文件
# init.write(open("c:\\test.init","w"))
